...
public class UserSP extends AbstractSP {
    ...
    private final static String KEY_SP_USER = "sjxg.user";
    private final static String KEY_SP_ADDR = "sjxg.addr";
    private final static String KEY_SP_USER_GUIDE = "sjxg_user_guide";
