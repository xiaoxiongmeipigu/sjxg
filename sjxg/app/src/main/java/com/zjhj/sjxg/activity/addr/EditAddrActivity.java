...
public class EditAddrActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        province = TextUtils.isEmpty(mapiAddrResult.getProvince_name())?"":mapiAddrResult.getProvince_name();
        city = TextUtils.isEmpty(mapiAddrResult.getCity_name())?"":mapiAddrResult.getCity_name();
        county = TextUtils.isEmpty(mapiAddrResult.getArea_name())?"":mapiAddrResult.getArea_name();

        provinceID = TextUtils.isEmpty(mapiAddrResult.getProvince_id())?"":mapiAddrResult.getProvince_id();
        cityID = TextUtils.isEmpty(mapiAddrResult.getCity_id())?"":mapiAddrResult.getCity_id();
        countyID = TextUtils.isEmpty(mapiAddrResult.getArea_id())?"":mapiAddrResult.getArea_id();

        name.setText(TextUtils.isEmpty(mapiAddrResult.getConsignee())?"":mapiAddrResult.getConsignee());
    ...
    private void modifyAddr(){
        ...
        showLoading();
        CommonApi.saveAddress(this,consignee, tel, provinceID, cityID, countyID, addressStr,isDefault+"",mapiAddrResult.getId(), new RequestCallback() {
            @Override
